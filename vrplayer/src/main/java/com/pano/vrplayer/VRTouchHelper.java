...
public class VRTouchHelper {
    ...
    private VRLibrary.IAdvanceGestureListener mAdvanceGestureListener;
    private List<VRLibrary.IGestureListener> mClickListeners = new LinkedList<>();
    ...
    public VRTouchHelper(Context context) {
        mGestureDetector = new GestureDetector(context, new GestureDetector.SimpleOnGestureListener() {
            ...
            public boolean onSingleTapConfirmed(MotionEvent e) {
                ...
                for (VRLibrary.IGestureListener listener : mClickListeners){
                    listener.onClick(e);
                }
                return true;
            }
    ...
    public void addClickListener(VRLibrary.IGestureListener gestureListener) {
        if (gestureListener != null) mClickListeners.add(gestureListener);
    }

    public void setAdvanceGestureListener(VRLibrary.IAdvanceGestureListener listener) {
