 ...
 */
public class VRBarrelDistortionLinePipe extends VRAbsLinePipe {

    private VR360Program mProgram;

    private MDBarrelDistortionMesh object3D;

    private VR360Director mDirector;
    ...
    public VRBarrelDistortionLinePipe(DisplayModeManager displayModeManager) {
        mDisplayModeManager = displayModeManager;
        mConfiguration = displayModeManager.getBarrelDistortionConfig();
        mProgram = new VR360Program(VRLibrary.ContentType.BITMAP);
        mDirector = new VR360DirectorFactory.OrthogonalImpl().createDirector(0);
    ...
    public void takeOver(int totalWidth, int totalHeight, int size) {
        ...
        glCheck("VRBarrelDistortionLinePipe glClear");
    }
    ...
    private void draw(int index){
        ...
        mProgram.use();
        glCheck("VRBarrelDistortionLinePipe mProgram use");
    ...
    private class MDBarrelDistortionMesh extends VRAbsObject3D {
