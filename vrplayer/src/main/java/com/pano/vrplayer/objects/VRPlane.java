...
import com.pano.vrplayer.strategy.projection.PlaneProjection;
 ...
 */
public class VRPlane extends VRAbsObject3D {

    private static final String TAG = "VRPlane";
    ...
    private VRPlane(PlaneProjection.PlaneScaleCalculator calculator, RectF size) {
        this.mCalculator = calculator;
        this.mSize = size;
    }

    public VRPlane(PlaneProjection.PlaneScaleCalculator calculator) {
        this(calculator,new RectF(0,0,1.0f,1.0f));
    }

    public VRPlane(RectF size) {
        this(new PlaneProjection.PlaneScaleCalculator(VRLibrary.PROJECTION_MODE_PLANE_FULL,new RectF(0,0,100,100)),size);
    }
    ...
    @Override
    public void uploadVerticesBufferIfNeed(VR360Program program, int index) {
