 ...
 */
public class VRDome3D extends VRAbsObject3D {
    ...
    public VRDome3D(RectF textureSize, float degree, boolean isUpper) {
    ...
    @Override
    public void uploadTexCoordinateBufferIfNeed(VR360Program program, int index) {
    ...
    private static void generateDome(float degree, boolean isUpper, VRDome3D object3D) {
        generateDome(18, 150, degree, isUpper, object3D);
    }

    public static void generateDome(float radius, int sectors, float degreeY, boolean isUpper, VRDome3D object3D) {
