...
public class VR360Director {
    ...
    protected VR360Director(Builder builder) {
    ...
    public void shot(VR360Program program) {
        shot(program, VRPosition.sOriginalPosition);
    }

    public void shot(VR360Program program, VRPosition modelPosition) {
    ...
    public static class Builder {
        ...
        public Builder setAngleX(float mAngle) {
            throw new RuntimeException("please use VRPosition");
        }
        ...
        public VR360Director build(){
            return new VR360Director(this);
        }
    }
}
